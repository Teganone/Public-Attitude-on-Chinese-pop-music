...
if __name__ == '__main__':
    ...
    for year in range(1991,2022):
        ...
        wordcloud_outfile = './data/wordcloud/wordcloud_music_bullet_year_{}.jpg'.format(year)
    ...
    # sentiment_sum_df.to_csv('./data/sentiment/comment_sentiment_sum.csv',encoding='utf_8_sig',mode='w',index=False)
